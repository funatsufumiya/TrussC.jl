...
1. Build dll/so/dylib by [tcxJuliaCxxWrap](https://github.com/funatsufumiya/tcxJuliaCxxWrap/)
...
4. In [TrussC.jl](https://github.com/funatsufumiya/TrussC.jl), update version number of [Project.toml](https://github.com/funatsufumiya/TrussC_prebuilt_jll/blob/main/Project.toml), and `julia --project=@. -e 'using Pkg; Pkg.update(); Pkg.instantiate()'` and update TrussC.jl (and also modify [src/TrussC.jl](https://github.com/funatsufumiya/TrussC.jl/blob/main/src/TrussC.jl) if needed, such as Base operator overloads and exports).