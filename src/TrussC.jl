module TrussC
  ...
  export x, y, z, w, width, height, set, set!, x!, y!, z!, w!,
    ...
    conjugate,
    rotate,
    # length, # NOTE: exporting length makes problems with Base.length, so please use TrussC.length instead
    lengthSquared,
    normalized,
    normalize,
    determinant,
    ...
    mixFrom,
    clip,
    SoundBuffer_getAdtsSampleRateIndex,
    SoundBuffer_createAdtsHeader,
    getAdtsSampleRateIndex,
    createAdtsHeader,
    init,
    shutdown,
    getAnalysisBuffer,
